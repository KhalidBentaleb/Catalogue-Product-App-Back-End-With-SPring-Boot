...
public class ExceptionHandling implements ErrorController {
    ...
    public ResponseEntity<HttpResponse> categoryNameNotFoundException(CategoryNameNotFoundException exception) {
        return createHttpResponse(BAD_REQUEST, exception.getMessage());
    }
    ...
    public ResponseEntity<HttpResponse> productNameNotFoundException(ProductNameNotFoundException exception) {
        return createHttpResponse(BAD_REQUEST, exception.getMessage());
    }
