...
import com.product.product.enumeration.Role;
...
import com.product.product.service.EmailService;
import com.product.product.service.LoginAttemptService;
...
import static com.product.product.constant.UserImplConstant.*;
...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    @Override
    public User addNewUser(String firstName, String lastName, String username, String email, String role) throws UserNotFoundException, UsernameExistException, EmailExistException, IOException {
        validateNewUsernameAndEmail(EMPTY, username, email);
        User user = new User();
        String password = generatePassword();
        user.setUserId(generateUserId());
    ...
    @Override
    public User updateUser(String currentUsername, String newFirstName, String newLastName, String newUsername, String newEmail, String role) throws UserNotFoundException, UsernameExistException, EmailExistException, IOException {
