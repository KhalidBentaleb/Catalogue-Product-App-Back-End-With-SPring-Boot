...
public class JWTTokenProvider {
    ...
    public String generateJwtToken(UserPrincipal userPrincipal) {
        ...
        return JWT.create().withIssuer(SecurityConstant.PRODUCT).withAudience(SecurityConstant.PRODUCT_ADMINISTRATION)
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try {
            ...
            verifier = JWT.require(algorithm).withIssuer(SecurityConstant.PRODUCT).build();
